...
import { GetHistoryFromDb } from '../services/DbProcess';
...
const HistoryScreen = ({ navigation }) => {
    ...
    const [busHistoryRoutes, setBusHistoryRoutes] = useState([]);
    ...
    useEffect(() => {
        ...
        setDataProvider(
            new DataProvider((r1, r2) => {
                return r1 !== r2;
            }).cloneWithRows(busHistoryRoutes)
        );
    }, [busHistoryRoutes]);
